...
// Struktur sama persis dengan moment.js
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    navLinks.forEach(link => {
        ...
        if (href && href.includes('loyalty.html')) {
            link.classList.add('active');
        } else if (href && !href.includes('loyalty.html')) {
    ...
    const animateElements = document.querySelectorAll('.benefit-card, .philosophy-item, .future-item');
...
window.addEventListener('load', function() {
    const heroTitle = document.querySelector('.loyalty-hero-title');
    const heroSubtitle = document.querySelector('.loyalty-hero-subheadline');
